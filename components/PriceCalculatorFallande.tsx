...
const products = [
  { article: 'Art.I1885', name: '4mm 40mm maska', price: 80, category: 'light', description: 'Bra allround-nät för fallande föremål' },
  { article: 'Art.I1886', name: '4mm 50mm maska', price: 70, category: 'light', description: 'Lättare föremål, god luftgenomsläpp' },
  { article: 'Art.I1886_F', name: '4mm 50mm maska flamskydd', price: 95, category: 'light', description: 'Flamskyddsbehandlad' },
  { article: 'Art.G101', name: '2,9mm 20mm maska', price: 100, category: 'light', description: 'Finmaskigt för smådelar' },
  { article: 'Art.I2005', name: '5mm 45mm maska EN1263-1', price: 123, category: 'medium', description: 'Klassat fallskyddsnät, även för personer' },
  { article: 'Art.I2008', name: '5mm 60mm maska EN1263-1', price: 99, category: 'medium', description: 'Klassat fallskyddsnät' },
  { article: 'Art.I2005_F', name: '5mm 45mm maska EN1263-1 flamskydd', price: 200, category: 'medium', description: 'Klassat + flamskyddsbehandlat' },
  { article: 'Art.I2004', name: '5mm 100mm maska EN1263-1', price: 66, category: 'medium', description: 'Stor maska, max luftgenomsläpp' },
  { article: 'Art.I2009', name: 'Kombonät 5mm 45 + 2,9mm 20 maska', price: 180, category: 'combo', description: 'Fångar både stora och små föremål' },
  { article: 'Art.I2009_2', name: 'Kombonät 5mm 45 + 2mm maska', price: 170, category: 'combo', description: 'Kombination för blandat skydd' },
  { article: 'Art.I2010', name: 'Kombonät 5mm 45 + 2,9mm + overlay', price: 220, category: 'combo', description: 'Trippelskydd med finmaskigt overlay' },
  { article: 'Art.I2010_2', name: 'Kombonät 5mm 45 + 2mm + overlay', price: 210, category: 'combo', description: 'Trippelskydd för maximalt skydd' },
  { article: 'REPNAT', name: 'Repnät med/utan stålvajer', price: 0, category: 'heavy', description: 'För tunga laster - kontakta oss för pris (250-1000 kr/kvm)' },
];

const categories = [
  { id: '', name: 'Visa alla', description: '' },
  { id: 'light', name: 'Lättare föremål', description: 'Verktyg, smådelar' },
  { id: 'medium', name: 'Medeltunga', description: 'Byggmaterial, sten' },
  { id: 'combo', name: 'Blandat', description: 'Stora + små' },
  { id: 'heavy', name: 'Tunga', description: 'Betong, berg' },
];

export default function PriceCalculatorFallande() {
      ...
      {selectedProduct && totalArea > 0 && (
        <div className="border-t mt-6 pt-6">
          ...
          <p className="text-xs text-gray-500 mt-3">
            {isHeavyCategory 
              ? 'Repnät dimensioneras individuellt. Kontakta oss för offert.'
        ...
        <div className="border-t mt-6 pt-6">
          ...
          {wantInstallation && (
            <div className="mt-4 bg-white border border-gray-200 rounded-lg p-4 space-y-4">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="industri">Industri / Fabrik</option>
                    <option value="lager">Lager / Logistik</option>
                    <option value="bro">Bro / Viadukt</option>
                    <option value="vindkraft">Vindkraftverk</option>
                    <option value="berg">Bergvägg / Tunnel</option>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Uppskattad fallhöjd</label>
                  <select 
                  ...
                  >
                    <option value="">Välj...</option>
                    <option value="0-3">0-3 meter</option>
                    <option value="3-7">3-7 meter</option>
                    <option value="7-15">7-15 meter</option>
                    <option value="15+">Över 15 meter</option>
                    <option value="unknown">Vet ej</option>
                  </select>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Föremålens vikt</label>
                  <select 
                    value={installationDetails.objectWeight} 
                    onChange={(e) => setInstallationDetails({ ...installationDetails, objectWeight: e.target.value })}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg"
                  >
                    <option value="">Välj...</option>
                    <option value="light">Lätt (under 5 kg)</option>
                    <option value="medium">Medel (5-50 kg)</option>
                    <option value="heavy">Tungt (50-500 kg)</option>
                    <option value="very-heavy">Mycket tungt (över 500 kg)</option>
                    <option value="unknown">Vet ej / Blandat</option>
                  </select>
                </div>
              </div>
            ...
            <div>
              ...
              <div>
                ...
                <textarea 
                  ...
                  placeholder="Beskriv vad som kan falla, tillgänglighet, tidsram..."
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg" 
                />
              </div>
