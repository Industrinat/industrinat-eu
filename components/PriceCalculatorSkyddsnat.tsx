...
const categories = [
  { id: '', name: 'Visa alla' },
  { id: 'fallskydd', name: 'Fallskydd person' },
  { id: 'fallande', name: 'Fallande föremål' },
  { id: 'fagel', name: 'Fågelskydd' },
  { id: 'sport', name: 'Sport & Bollstopp' },
  { id: 'industri', name: 'Industri & Avgränsning' },
];

const products = [
  // Fallskydd person (EN1263-1)
  { article: 'Art.F2005', name: '5mm 45mm EN1263-1', price: 123, category: 'fallskydd', description: 'Personskydd, klassad' },
  { article: 'Art.F2008', name: '5mm 60mm EN1263-1', price: 99, category: 'fallskydd', description: 'Personskydd, klassad' },
  { article: 'Art.F2004', name: '5mm 100mm EN1263-1', price: 66, category: 'fallskydd', description: 'Personskydd, klassad, grövre maska' },
  { article: 'Art.F2005_F', name: '5mm 45mm EN1263-1 flamskydd', price: 200, category: 'fallskydd', description: 'Personskydd med flamskydd' },
  
  // Fallande föremål
  { article: 'Art.I1885', name: '4mm 40mm', price: 80, category: 'fallande', description: 'Tät maska, lätta föremål' },
  { article: 'Art.I1886', name: '4mm 50mm', price: 70, category: 'fallande', description: 'Standard, lätta föremål' },
  { article: 'Art.I1886_F', name: '4mm 50mm flamskydd', price: 95, category: 'fallande', description: 'Med flamskydd' },
  { article: 'Art.I2009', name: 'Kombonät 5mm 45 + 2,9mm 20', price: 180, category: 'fallande', description: 'Dubbelt skydd, finmaskigt overlay' },
  { article: 'Art.I2010', name: 'Kombonät 5mm 45 + overlay', price: 220, category: 'fallande', description: 'Trippelskydd' },
  { article: 'Art.G101', name: '2,9mm 20mm', price: 100, category: 'fallande', description: 'Finmaskigt, små delar' },
  
  // Fågelskydd
  { article: 'Art.B1889', name: '3mm 50mm svart', price: 40, category: 'fagel', description: 'Stora fåglar (mås, duva)' },
  { article: 'Art.B2002', name: '2mm 20mm svart', price: 50, category: 'fagel', description: 'Alla fågeltyper' },
  { article: 'Art.B1599', name: '3mm 40mm', price: 80, category: 'fagel', description: 'Medelstora fåglar' },
  { article: 'Art.BG1001', name: '2,9mm 20mm', price: 90, category: 'fagel', description: '10 års garanti, premium' },
  { article: 'Art.B1886_F', name: '4mm 50mm flamskydd', price: 100, category: 'fagel', description: 'Fågelskydd med flamskydd' },
  
  // Sport & Bollstopp
  { article: 'Art.S2001', name: '2mm 20mm golf', price: 80, priceVolume: 50, category: 'sport', description: 'Golfnät, rangenät' },
  { article: 'Art.S2003', name: '2,9mm 20mm golf premium', price: 100, priceVolume: 80, category: 'sport', description: '3 års garanti' },
  { article: 'Art.S3001', name: '3mm 100mm bollstopp', price: 40, category: 'sport', description: 'Fotboll, ekonomi' },
  { article: 'Art.S3002', name: '4mm 100mm bollstopp', price: 50, category: 'sport', description: 'Fotboll, standard' },
  { article: 'Art.S4002', name: '3mm 40mm multisport', price: 70, category: 'sport', description: 'Tennis, padel, handboll' },
  { article: 'Art.S4004', name: '4mm 40mm multisport', price: 90, category: 'sport', description: 'Premium multisport' },
  
  // Industri & Avgränsning
  { article: 'Art.N1886', name: '4mm 50mm svart', price: 70, category: 'industri', description: 'Avgränsning, standard' },
  { article: 'Art.N1885', name: '4mm 40mm svart', price: 80, category: 'industri', description: 'Avgränsning, tätare' },
  { article: 'Art.N2005', name: '5mm 45mm', price: 123, category: 'industri', description: 'Tung industri' },
  { article: 'Art.N100', name: '3mm 100mm', price: 40, category: 'industri', description: 'Lätt avgränsning' },
];

export default function PriceCalculatorSkyddsnat() {
  ...
  const getCategoryColor = (catId: string) => {
    switch(catId) {
      case 'fallskydd': return 'bg-red-500';
      case 'fallande': return 'bg-orange-500';
      case 'fagel': return 'bg-blue-500';
      case 'sport': return 'bg-green-500';
      case 'industri': return 'bg-gray-700';
  ...
  return (
    <div className="bg-gray-50 rounded-lg p-6 max-w-2xl">
      {/* Kategori filter */}
      <div className="mb-6">
        <label className="block text-sm font-medium text-gray-700 mb-2">Välj användningsområde</label>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="bygg">Byggarbetsplats</option>
                    <option value="industri">Industri / Lager</option>
                    <option value="fasad">Fasad / Tak</option>
                    <option value="sport">Sportanläggning</option>
                    <option value="skola">Skola / Förskola</option>
                    <option value="bostadsratt">Bostadsrättsförening</option>
                    <option value="offentlig">Offentlig miljö</option>
                    <option value="ovrigt">Övrigt</option>
                  </select>
                </div>
              </div>

              {(selectedCategory === 'fallskydd' || selectedCategory === 'fallande') && (
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Fallhöjd</label>
                  <select 
                    value={installationDetails.fallHeight} 
                    onChange={(e) => setInstallationDetails({ ...installationDetails, fallHeight: e.target.value })}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg"
                  >
                    <option value="">Välj...</option>
                    <option value="0-3m">0-3 meter</option>
                    <option value="3-7m">3-7 meter</option>
                    <option value="7-15m">7-15 meter</option>
                    <option value="15+m">Över 15 meter</option>
                  ...
                  <label className="flex items-start gap-3 cursor-pointer">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 mt-1">
                        ...
                        Drop-nätet tar första touch vid hårda skott.
                      </p>
                    </div>
                  </label>
                </div>
